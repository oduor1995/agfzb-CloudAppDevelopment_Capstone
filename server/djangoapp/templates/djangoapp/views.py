...
def get_dealerships(request):
    if request.method == "GET":
        ...
        # Create a list of dictionaries with dealer details for the table
        dealer_data = []
        for dealer in dealerships:
            dealer_dict = {
                'id': dealer.id,
                'name': dealer.short_name,
                'city': dealer.city,
                'address': dealer.address,
                'zip': dealer.zip,
            }
            dealer_data.append(dealer_dict)
        # Update the context dictionary with the dealer data
